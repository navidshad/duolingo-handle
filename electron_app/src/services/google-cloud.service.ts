...
export class GoogleCloud {
  ...
  constructor(apiKey = "") {
    ...
    ipcMain.handle("gcloud:detect-text-positions", (event, data) =>
      this.detectTextPositionsFromImage(data),
    );
    ipcMain.handle("gcloud:detect-text", (event, data) =>
      this.detectTextFromImage(data),
    );
    ipcMain.handle("gcloud:detect-text-from-audio", (event, data) =>
      this.detectTextFromAudio(data),
    );
    ipcMain.handle("gcloud:translate-text", (event, data) =>
