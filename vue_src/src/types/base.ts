...
export type ToolType = 'none' | 'conversation' | 'words-detector' | 'writing-guide' | 'voice-recognition' | 'gap-filler' | 'speaking';
...
export type WindowType = 'tools-box' | ToolType | SubtoolType;
